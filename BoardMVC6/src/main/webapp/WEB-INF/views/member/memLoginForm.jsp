				...
				<form action="${cp}/member/memLogin.do" method="post">
					<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
						<tr>
							...
							<td>
								<input id="memID" name="username" class="form-control" type="text" maxlength="20"
						...
						<tr>
							...
							<td colspan="2">
								<input id="memPassword" name="password" class="form-control" type="password" maxlength="20"
